...
import by.tomal.cleancode.R
import by.tomal.cleancode.app.common.ItemOffsetDecoration
import by.tomal.cleancode.presentation.base.BaseMvvmFragment
import by.tomal.cleancode.presentation.ui.vehicle.list.adapter.VehicleListAdapter
...
class VehicleListFragment : BaseMvvmFragment<VehicleListViewModel>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvVehicles.layoutManager = LinearLayoutManager(requireContext()) as RecyclerView.LayoutManager?
        rvVehicles.adapter = VehicleListAdapter(
            requireContext(),
            viewModel
        )
